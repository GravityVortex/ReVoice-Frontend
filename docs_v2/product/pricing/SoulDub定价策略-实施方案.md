...
本文是基于《SoulDub定价策略》（`docs_v2/product/pricing/SoulDub定价策略.md`）的**落地实施清单**，并对照当前仓库代码，明确需要改哪些、怎么改、验收口径是什么。
...
- `docs_v2/integration/java-implementation.md`（A 订阅月积分发放定时任务 / B 调度与 claim）
