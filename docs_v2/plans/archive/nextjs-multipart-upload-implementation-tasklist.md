...
本文是对 `docs_v2/howto/nextjs-multipart-upload-api.md`（v1.3）的**落地任务清单**与**验收用例**，用于确保“分片上传 + Java 控制面 + Next 网关 + 任务链路”最终可用。
...
按 `docs_v2/howto/nextjs-multipart-upload-api.md` 第 4 章提供接口：
