...
//         }
//         if (subtitleAudio3Ref.current && !isSubtitleMuted) {
...
//    */
//   const doUpdateAudioPlayPause = (newTime: number, offset = 0) => {
//     // 查找当前时间对应的字幕
...
//         return newTime >= (subtitle.startTime - 100) && newTime < endTime;
//       });
...
//         console.log('subtitle------>', subtitleCur?.startTime, 'duration:', subtitleCur?.duration, 'endTime', subtitleCur?.startTime + subtitleCur?.duration);
//         if (cha < 0) {
...
//         // 2: audio3播放2, audio1预加载3
//         // 3: audio1播放3, audio2预加载4
//         // 4: audio2播放4, audio3预加载5
//         // 5: audio3播放5, audio1预加载6

//         const audioIndex = currentSubtitleIndex % 3;
//         const audioRefs = [subtitleAudioRef, subtitleAudio2Ref, subtitleAudio3Ref];
//         const nextAudioIndex = (currentSubtitleIndex + 1) % 3;
