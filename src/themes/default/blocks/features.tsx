      ...
      <div className={`container space-y-8 md:space-y-16`}>
        <ScrollAnimation>
          <div className="mx-auto max-w-4xl text-center text-balance">
            ...
            <p className="text-[rgba(255,255,255,0.6)] mb-6 md:mb-12 lg:mb-16 text-lg">
            ...
            {features.items?.map((item, idx) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-base text-[rgba(255,255,255,0.6)] leading-relaxed">{item.description}</p>
                </div>
              </div>
            ))}
          </div>
