          ...
          <div className="relative mx-auto max-w-5xl overflow-hidden rounded-3xl border border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.05)] p-8 md:p-12 backdrop-blur-md shadow-2xl">
            ...
            <div className="grid gap-12 lg:grid-cols-2 items-center relative z-10">
              ...
              <div className="text-left space-y-6">
                ...
                <p className="text-lg text-[rgba(255,255,255,0.7)] leading-relaxed max-w-md">
                  {stats.description}
                </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
                {stats.items?.map((item, idx) => (
                  <div key={idx} className="flex flex-col gap-2">
                    <div className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-white to-[rgba(255,255,255,0.5)]">
                      {item.title}
                    </div>
                    <div className="text-sm font-medium text-[rgba(255,255,255,0.5)] uppercase tracking-wider">
                      {item.description}
                    </div>
                  </div>
                ))}
