...
export async function GET(req: Request) {
  try {
    ...
    // 4. TODO 查询任务列表中最终文件vt_file_final(1个task有3个final文件【video/subtitle/preview】)
    // const finalFileList = await getVtFileFinalListByTaskIds(taskIdArr);
    const finalFileList: any[] = [{
      id: '1',
      taskId: taskList[0].id,
      userId: '001',
      fileType: 'preview',// 文件类型:video/subtitle/preview'
    ...
    },
    {
      ...
      taskId: taskList[0].id,
      userId: '001',
      fileType: 'video',// 文件类型:video/subtitle/preview'
      fileSizeBytes: 2419199,
      r2Key: 'temp_test/test3-final.mp4',
      r2Bucket: 'zhesheng',
      createdAt: '2025-12-07T11:24:05.135Z',
